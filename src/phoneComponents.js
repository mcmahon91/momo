...
class OnePhone extends Component {
    ...
    updateDevice = (a, index) => {
        ...
        const updatedDeviceInfo = {key: index, id: deviceID, make: make, model: model, os: os, checkOutTime: this.props.checkedOutTime, checkedOutBy: this.props.checkedOutBy, name: this.props.name}
